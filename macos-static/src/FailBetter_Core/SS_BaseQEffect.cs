...
{
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(BaseQEffect.PossessorSatisfiesIfNoMoreThan), new []{typeof(IPossessesQualities), typeof(CoreResultInfo)}, new[] {ArgumentType.Normal, ArgumentType.Ref})]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(BaseQEffect.PossessorSatisfiesOnlyIfAtLeast),
        new[] { typeof(IPossessesQualities), typeof(CoreResultInfo) }, new[] { ArgumentType.Normal, ArgumentType.Ref })]
