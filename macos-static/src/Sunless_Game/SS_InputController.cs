...
public class SS_InputController
{
    ...
    [HarmonyPrefix]
    [HarmonyPatch(nameof(InputController.GetKeyDown), typeof(string))]
    ...
    [HarmonyPrefix]
    [HarmonyPatch(nameof(InputController.GetKeyUp), typeof(string))]
    ...
    [HarmonyPrefix]
    [HarmonyPatch(nameof(InputController.GetKey), typeof(string))]
    ...
    [HarmonyPrefix]
    [HarmonyPatch(nameof(InputController.GetTooltipValue), typeof(string))]
