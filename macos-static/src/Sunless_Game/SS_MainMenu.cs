...
public class SS_MainMenu
{
    ...
    [HarmonyTranspiler]
    [HarmonyPatch("SetupSaveButton", typeof(MainMenu.ButtonData))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch("SetupLoadButton", typeof(MainMenuButton))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch("ShowActivateDialog", typeof(string))]
