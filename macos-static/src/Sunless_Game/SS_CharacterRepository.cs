...
{
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CharacterRepository.LoadGame), typeof(string))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CharacterRepository.Save), typeof(string), typeof(SunlessCharacter))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CharacterRepository.Create), typeof(string), typeof(SerializableTileConfig))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CharacterRepository.CreateGenericCharacter), typeof(string), typeof(SerializableTileConfig))]
