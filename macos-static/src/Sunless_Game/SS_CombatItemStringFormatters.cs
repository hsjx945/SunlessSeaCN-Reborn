...
{
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CombatItemStringFormatters.GetTooltip), typeof(CombatItem), typeof(string))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CombatItemStringFormatters.GetHotkey), typeof(int))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CombatItemStringFormatters.GetHullTooltip), typeof(CombatAttack), typeof(Character))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CombatItemStringFormatters.GetLifeTooltip), typeof(CombatAttack), typeof(Character))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CombatItemStringFormatters.GetCrewTooltip), typeof(CombatAttack), typeof(Character))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CombatItemStringFormatters.GetTimeTooltip), typeof(CombatAttack), typeof(Character))]
    ...
    [HarmonyTranspiler]
    [HarmonyPatch(nameof(CombatItemStringFormatters.GetStaggerTooltip), typeof(CombatAttack), typeof(Character))]
