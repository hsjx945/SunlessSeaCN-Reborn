...
{
    [HarmonyPrefix]
    [HarmonyPatch(MethodType.Constructor, typeof(GameObject), typeof(string), typeof(Action), typeof(string), typeof(Action), typeof(string), typeof(string))]
    ...
    //[HarmonyTranspiler]
    [HarmonyPostfix]
    [HarmonyPatch(MethodType.Constructor, typeof(GameObject), typeof(Action), typeof(Action), typeof(string), typeof(string))]
